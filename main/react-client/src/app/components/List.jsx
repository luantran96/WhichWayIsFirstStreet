        ...
        <ul className="navbar-nav mr-auto">
          <li className="nav-item dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="dropdown01">
              <span className="dropdown-item" onClick={() => filterBy('ratings')}>
                Rating
              </span>
              <span className="dropdown-item" onClick={() => filterBy('distance')}>
                Distance
              </span>
              <span className="dropdown-item" onClick={() => filterBy('reviews')}>
                most reviews
              </span>
            </div>
          </li>
